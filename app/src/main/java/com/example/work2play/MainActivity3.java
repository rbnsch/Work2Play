...
public class MainActivity3 extends AppCompatActivity {
    ...
    public static void setCoins(int coins) {
        MainActivity3.coins = savedCoins.getInt("coins", 0);
        coinsTextTasks.setText(String.valueOf(MainActivity3.coins) + " Coins");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coinsTextTasks = (TextView) findViewById(R.id.coins);
